				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="controller/authcontroller.php?page=logout"><svg class="glyph stroked cancel">
		...
		<ul class="nav menu">
			...
			if ($_SESSION['level'] == 'operator' or $_SESSION['level'] == 'admin') {
				...
				if (isset($_GET['page']) && $_GET['page'] == 'penjualan') {
					echo '<li class="active"><a href="index.php?page=penjualan"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg>Data Penjualan</a></li>';
				} else {
					echo '<li><a href="index.php?page=penjualan"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg>Data Penjualan</a></li>';
				}
			}
			if ($_SESSION['level'] == 'admin') {
				// DATA USER
				if (isset($_GET['page']) && $_GET['page'] == 'kasir') {
					echo '<li class="active"><a href="index.php?page=kasir"><svg class="glyph stroked star"><use xlink:href="#stroked-star"></use></svg> Data User</a></li>';
				} else {
					echo '<li><a href="index.php?page=kasir"><svg class="glyph stroked star"><use xlink:href="#stroked-star"></use></svg> Data User</a></li>';
				}
			}
			?>

			<div class="attribution">Proyek 1 2023<br /></div>
	</div>
<!-- sidebar end  -->
